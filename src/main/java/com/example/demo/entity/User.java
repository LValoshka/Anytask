...
public class User {
    ...
    public User(String name, String surname, String username, String password, String passwordConfirm, Set<Role> roles, Set<StudentTaskStatus> studentTaskStatusSet, Set<Course> studentCourseSet, Set<Course> teacherCourseSet) {
        this.name = name;
